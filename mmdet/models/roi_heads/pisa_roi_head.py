...
from mmdet.models import carl_loss, isr_p
from .. import builder
...
class StandardRoIHead(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
        ...
        if self.with_bbox or self.with_mask:
            ...
            for i in range(num_imgs):
                ...
                if isinstance(sampling_result, tuple):
                    sampling_result, neg_sample_weight = sampling_result
                else:
                    neg_sample_weight = None
                sampling_results.append(sampling_result)
                neg_label_weights.append(neg_sample_weight)
    ...
    def _bbox_forward_train(self,
        ...
        if lable_weight_cfg is not None:
            bbox_targets, info = isr_p(cls_score, bbox_pred, bbox_targets,
                                       rois, sampling_results,
        ...
        if carl_loss_cfg is not None:
            loss_carl, carl_loss_info = carl_loss(cls_score, bbox_targets[0],
                                                  bbox_pred, bbox_targets[2],
