    ...
    train=dict(
        ...
        auto_augment_policies=[
            ...
            dict(
                ...
                axis='y',
                replace=replace),
            dict(type='Cutout', prob=0.8, level=8, replace=replace),
            dict(type='Shear', prob=1.0, level=2, replace=replace, axis='y'),
            dict(
                type='TranslateOnlyBBox',
                prob=0.6,
                level=6,
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_auto_augment_r50_fpn_2x'
load_from = None
resume_from = None
workflow = [('train', 1)]
